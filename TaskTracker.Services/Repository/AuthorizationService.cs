...
namespace TaskTracker.Services.Repository
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        public async Task<string> AddRoleAsync(string roleName, string tenantId)
        {
            var identityRole = new Role();
            identityRole.Name = roleName;
            identityRole.TenantId =int.Parse(tenantId);
        ...
        public async Task<string> EditRoleAsync(EditRoleRequest request, string tenantId)
        {
        ...
        public async Task<string> DeleteRoleAsync(int roleId, string tenantId)
        {
